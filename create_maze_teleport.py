...
with open('input/advance/maze_teleport3.txt', 'w') as outfile:
    ...
    outfile.write('x  x   x                    xT\n');
    outfile.write('x  x x x x                  xx\n');
    outfile.write('x  x x x xxxxxxxxxxxxxxxxxx  x\n');
    outfile.write('x  x x   xT                  x\n');
